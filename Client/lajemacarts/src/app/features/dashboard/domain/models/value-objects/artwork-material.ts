...
export class ArtworkMaterial {
  ...
  public static create(materialId: string, unit: string, quantity: number): Result<ArtworkMaterial> {
    if (!materialId) {
    ...
    return Result.success(new ArtworkMaterial(materialId, unit, quantity));
  }
}
